...
To package the chart with the name `standalone-app` 

```shell
cd idp-platform-factory/charts/kafi-standalone-app
helm package ./application
helm push standalone-app-1.1.0.tgz oci://uat-harbor.kafisc.vn/charts/kafi
```
